...
<tr>
<td>User Name:</td>
<td><input type="text" name="userName"><br/><span id="userName"></span></td>
</tr>
<tr><td><div id="space"></div></td></tr>
<tr>
<td>Password:</td>
<td><input type="password" name="password"><br/><span id="password"></span></td>
</tr>
<tr><td><div id="space"></div></td></tr>
</table>
