		...
		$(document)
				.ready(
						function() {
							...
							document.getElementById("numberOfItems").innerHTML = "Items - "
									+ i;
					...
					.ready(
							function() {
								if (i == 0) {
									...
									$("#inventory")
											.append(
													" <tr><td><b>Item code</b></td><td><b>Item name</b></td><td><b>Item type</b></td><td><b>Item Price</b></td> <td><b>Quantity</b></td></tr>");
									$("#inventory")
											.append(
													"<tr  id=row"+buttonId+"><td><input name=itemCodeData value="+itemCode+" readonly></td><td><input name=itemNameData value="+itemName+" readonly></td><td><input name=itemTypeData value="+itemType+" readonly></td><td><input name=itemPriceData value="+itemPrice+" readonly></td><td><input name=quantityData value="+quantity+" readonly></td><td><button id="
															+ buttonId
															+ " onclick=itemRemove(this.id)>Delete</button><td></tr>");
									i = i + 1;
									buttonId = buttonId + 1;
								} else {
									if (i % 2 != 0) {
			...
			<div>
				<table>
					...
					<tr>
						<td></td>
						<td></td>
						<td><button type="button" onclick="return anotherItem()">Add
								Item</button></td>
					</tr>
